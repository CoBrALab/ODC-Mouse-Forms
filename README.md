...
After requesting account to be created with your group admin, you can log in and access the MouseODC  [here](https://mouseodc.douglasneuroinformatics.ca/auth/login). Now publicly accessible outside to the Douglas network :) !
