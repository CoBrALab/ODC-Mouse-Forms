...
export default defineInstrument({
  ...
  clientDetails: {
    estimatedDuration: 2,
    instructions: [
      "Please answer the forms questions as accurately as possible, this form is meant be filled in per mouse used",
    ],
  },
  details: {
    description:
      "This is a form to collect data from a mouses touchscreen session",
    license: "Apache-2.0",
